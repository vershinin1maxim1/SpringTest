...
//     List<Product> findDistinctByAttributes(Set<Attribute> attributes);
    ...
    List<ProductProxyFilterDto> countOfAttributesByParam(@Param("attributeIds") Set<Integer> attributeIds, @Param("minPrice") Integer minPrice, @Param("maxPrice") Integer maxPrice, @Param("minFrame")  Integer minFrame, @Param("maxFrame")  Integer maxFrame);
    ...
    ProductProxyFilterDto countAllByParam(@Param("attributeIds") Set<Integer> attributeIds, @Param("minPrice") Integer minPrice, @Param("maxPrice") Integer maxPrice, @Param("minFrame")  Integer minFrame, @Param("maxFrame")  Integer maxFrame);
